...
пароль и имя пользователя, второй от кого, к кому посылается сообщение  и текст сообщения, третий класс включает в себя список пользователей, 
списки сообщения и текущего активного пользователя. При помощи соответствующих функций, пользователь может сначала 
зарегистрировать свой аккаунт, после написать сообщение либо всем пользователям либо конкретному, просмотреть сообщение 
и вернуться в главное меню. После этого в чате есть возможность создать новый аккаунт, войти в него и совершать аналогичные действия. 
...
Класс Message - класс, включающий о себе информацию о передаваемых сообщениях, От кого, К кому и сам текст сообщения. 
Класс Chat - класс, включающий в себя  динамические массивы текущих пользователей и сообщений, так же имеет информацию о текущем активном пользователе.
Функции:
void login();  Авторизация в чате по уже созданному логину и паролю
...
void addMessage() Формирование сообщения
